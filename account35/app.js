...
app.get('/instagram', function(req, res) {
  var url = "https://www.instagram.com/s_okna_doma_tvoego/?__a=1";
  ...
  request(url, function(error, response, html) {
    ...
    if( !error ){
      ...
      fs.writeFile('instagram_output.js', "var instagram_account_s_okna_doma_tvoego = " + JSON.stringify(instagram_data), function(error){
