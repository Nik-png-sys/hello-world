...
app.get('/instagram', function(req, res) {
  var url = "https://www.instagram.com/sovietinnerness/?__a=1";
  ...
  request(url, function(error, response, html) {
    ...
    if( !error ){
      ...
      fs.writeFile('instagram_output.js', "var instagram_account_sovietinnerness = " + JSON.stringify(instagram_data), function(error){
